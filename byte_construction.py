...
# Title: Byte Construction
# Generated: Fri Jun  7 00:55:21 2019
##################################################
...
class byte_construction(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=byte_construction, options=None):
