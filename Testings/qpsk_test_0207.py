...
# Title: Qpsk Test 0207
# Generated: Mon Feb 10 11:42:06 2020
##################################################
...
class qpsk_test_0207(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.qtgui_time_sink_x_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "len_key")
        ...
        self.qtgui_time_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "len_key")
        ...
        self.digital_lms_dd_equalizer_cc_0 = digital.lms_dd_equalizer_cc(15, 19E-3, 8, qpsk)
        ...
        self.blocks_stream_to_tagged_stream_1 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 15, "len_key")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/peter/Desktop/acoustic_radio/Testings/test0.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_char*1, 58)
        ...
        self.connect((self.blocks_float_to_complex_1, 0), (self.qtgui_freq_sink_x_0, 0))
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_delay_0, 0))
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_char_to_float_0_0_0, 0))
        ...
        self.connect((self.digital_protocol_formatter_bb_0, 0), (self.blocks_char_to_float_0_0, 0))
...
def main(top_block_cls=qpsk_test_0207, options=None):
    if options is None:
