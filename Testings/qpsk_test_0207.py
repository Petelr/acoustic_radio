...
# Generated: Mon Feb 17 14:56:42 2020
##################################################
...
class qpsk_test_0207(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.qtgui_time_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "len_key")
        ...
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 48*10, "len_key")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/peter/Desktop/acoustic_radio/Testings/test_input.txt', False)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_float_to_complex_1, 0))
        ...
        self.connect((self.blocks_repack_bits_bb_0_1, 0), (self.blks2_tcp_sink_0_0, 0))
        ...
        self.connect((self.blocks_tag_gate_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_tag_gate_0, 0), (self.blocks_repack_bits_bb_0_1, 0))
