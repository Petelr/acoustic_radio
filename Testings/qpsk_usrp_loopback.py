...
# Generated: Fri Apr  3 22:43:09 2020
##################################################
...
class qpsk_usrp_loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.carrier_freq = carrier_freq = 1000e4
        ...
        self.high_pass_filter_0 = filter.fir_filter_ccf(1, firdes.high_pass(
        	1, samp_rate, 50, 20, firdes.WIN_HAMMING, 6.76))
        ...
        self.connect((self.high_pass_filter_0, 0), (self.digital_corr_est_cc_0, 0))
        self.connect((self.high_pass_filter_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.high_pass_filter_0, 0), (self.qtgui_time_sink_x_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.high_pass_filter_0.set_taps(firdes.high_pass(1, self.samp_rate, 50, 20, firdes.WIN_HAMMING, 6.76))
