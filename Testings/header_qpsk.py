...
# Title: Header Qpsk
# Generated: Fri Feb  7 14:56:40 2020
##################################################
...
class header_qpsk(gr.top_block, Qt.QWidget):

    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        gr.top_block.__init__(self, "Header Qpsk")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Header Qpsk")
        ...
        self.settings = Qt.QSettings("GNU Radio", "header_qpsk")
        ...
        self.blocks_file_sink_1_0 = blocks.file_sink(gr.sizeof_char*1, '/home/peter/Desktop/acoustic_radio/Testings/test0.txt', False)
        ...
        self.connect((self.blocks_throttle_1, 0), (self.digital_pfb_clock_sync_xxx_0_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.digital_diff_decoder_bb_0, 0))
        self.connect((self.digital_constellation_modulator_0, 0), (self.blocks_throttle_1, 0))
        self.connect((self.digital_diff_decoder_bb_0, 0), (self.blocks_file_sink_1_0, 0))
...
def main(top_block_cls=header_qpsk, options=None):
    if options is None:
