...
# Title: Mpsk Stage6
# Generated: Fri Jun  7 15:26:50 2019
##################################################
...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.delay = delay = 58
        self.arity = arity = 4
        self.a_code = a_code = "0111000110101100011001011000011101011010010"
        ...
        self.connect((self.blks2_packet_encoder_0, 0), (self.blocks_unpack_k_bits_bb_0_0, 0))
        ...
        self.connect((self.blocks_char_to_float_0_0_1, 0), (self.qtgui_time_sink_x_2, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_char_to_float_0_0_1, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0, 0), (self.myblocks_qpsk_demod_v2_0, 0))
        ...
        self.connect((self.myblocks_qpsk_demod_v2_0, 0), (self.blocks_char_to_float_0, 0))
