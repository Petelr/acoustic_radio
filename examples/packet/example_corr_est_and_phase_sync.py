...
# Generated: Thu Mar  5 15:25:44 2020
##################################################
...
class example_corr_est_and_phase_sync(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        [self.top_grid_layout.setRowStretch(r,1) for r in range(0,1)]
        [self.top_grid_layout.setColumnStretch(c,1) for c in range(1,2)]
        self._freq_off_range = Range(-0.25, 0.25, 0.0001, 0.0, 200)
        ...
        self.qtgui_time_sink_x_1.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.0, 2, 0, 'packet_len')
        ...
        [self.tab1_grid_layout_1.setRowStretch(r,1) for r in range(0,1)]
        [self.tab1_grid_layout_1.setColumnStretch(c,1) for c in range(0,1)]
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
        	512, #size
        	"After Phase Lock", #name
        	1 #number of inputs
        )
        ...
        [self.tab1_grid_layout_1.setRowStretch(r,1) for r in range(0,1)]
        [self.tab1_grid_layout_1.setColumnStretch(c,1) for c in range(1,2)]
        ...
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.qtgui_time_sink_x_1, 0))
