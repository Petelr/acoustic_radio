...
# Generated: Fri May 31 16:23:35 2019
##################################################
...
class chat_app(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.myblocks_qpsk_demod_v2_0 = myblocks.qpsk_demod_v2(1)
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.myblocks_qpsk_demod_v2_0, 0))
        self.connect((self.myblocks_qpsk_demod_v2_0, 0), (self.blocks_repack_bits_bb_1, 0))
