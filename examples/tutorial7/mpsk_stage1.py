...
class mpsk_stage1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._exbw_range = Range(0.001, 0.5, 0.01, 0.22, 200)
        self._exbw_win = RangeWidget(self._exbw_range, self.set_exbw, "exbw", "counter_slider", float)
        self.top_layout.addWidget(self._exbw_win)
