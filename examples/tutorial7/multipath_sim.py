...
# Title: Multipath Sim
# Generated: Fri Apr  5 15:47:57 2019
##################################################
...
class multipath_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        [self.top_grid_layout.setColumnStretch(c,1) for c in range(14,15)]
        ...
        [self.top_grid_layout.setRowStretch(r,1) for r in range(0,1)]
        [self.top_grid_layout.setColumnStretch(c,1) for c in range(13,14)]
        ...
        [self.top_grid_layout.setRowStretch(r,1) for r in range(0,1)]
        [self.top_grid_layout.setColumnStretch(c,1) for c in range(12,13)]
        ...
        [self.top_grid_layout.setRowStretch(r,1) for r in range(0,1)]
        [self.top_grid_layout.setColumnStretch(c,1) for c in range(11,12)]
