...
# Title: Message Test
# Generated: Wed Oct  2 23:52:19 2019
##################################################
...
class message_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 2e3
        self.arity = arity = 4
        ...
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (rrc_taps), nfilts, nfilts/2, 1.5, 4)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((2, 1, 3,  2), True, 1, [])
        ...
        self.blocks_char_to_float_1_0 = blocks.char_to_float(1, .5)
        ...
        self.connect((self.blocks_char_to_float_1, 0), (self.blocks_add_const_vxx_0_0, 0))
        self.connect((self.blocks_char_to_float_1_0, 0), (self.blocks_add_const_vxx_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.digital_binary_slicer_fb_0_0, 0))
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.digital_binary_slicer_fb_1, 0))
        self.connect((self.blocks_multiply_xx_0_1, 0), (self.digital_binary_slicer_fb_1_0, 0))
        ...
        self.connect((self.digital_binary_slicer_fb_1_0, 0), (self.blocks_char_to_float_1_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0_0, 0), (self.blocks_uchar_to_float_0_1, 0))
