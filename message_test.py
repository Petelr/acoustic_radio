...
# Title: Message Test
# Generated: Sun Oct  6 21:29:51 2019
##################################################
...
class message_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 250e3
        self.arity = arity = 4
        ...
        self.qtgui_time_sink_x_2.set_y_axis(-1, 2)
        ...
        self.analog_random_uniform_source_x_0 = analog.random_uniform_source_b(50, 51, 0)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_random_uniform_source_x_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.analog_random_uniform_source_x_0, 0), (self.blocks_unpack_k_bits_bb_0_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_0_1_0, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0_0, 0), (self.blocks_uchar_to_float_0_1_0, 0))
