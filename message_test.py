...
# Title: Message Test
# Generated: Mon Oct  7 17:25:17 2019
##################################################
...
class message_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.lpf_cutoff_freq = lpf_cutoff_freq = 300e3
        self.excess_bw = excess_bw = 0.35
        self.eq_gain = eq_gain = 10e-3
        self.center_freq = center_freq = 1000e3
        self.arity = arity = 4
        ...
        self.qtgui_time_sink_x_2.set_y_axis(-1, 260)
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
        	1024, #size
        	samp_rate, #samp_rate
        	"Numbers Before and After Modulation", #name
        	2 #number of inputs
        )
        self.qtgui_time_sink_x_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0.set_y_axis(-0.5, 260)

        self.qtgui_time_sink_x_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0.enable_tags(-1, True)
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 1, 0, 0, "packet_len")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(1, firdes.low_pass(
        	1, samp_rate, lpf_cutoff_freq, lpf_transition_width, firdes.WIN_HAMMING, 6.76))
        self.digital_pfb_clock_sync_xxx_0_0_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (rrc_taps), nfilts, nfilts/2, 1.5, 8)
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(sps, timing_loop_bw, (rrc_taps), nfilts, nfilts/4, 1.5, 8)
        ...
        self.delay1_0 = blocks.delay(gr.sizeof_float*1, 12+58)
        self.delay1 = blocks.delay(gr.sizeof_float*1, 12)
        self.blocks_uchar_to_float_0_0 = blocks.uchar_to_float()
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_char*1, samp_rate,True)
        self.blocks_repack_bits_bb_0_0 = blocks.repack_bits_bb(8, 8, "", False, gr.GR_LSB_FIRST)
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(8, 8, "", False, gr.GR_LSB_FIRST)
        ...
        self.analog_random_uniform_source_x_0 = analog.random_uniform_source_b(254, 255, 0)
        ...
        self.connect((self.blocks_char_to_float_1, 0), (self.delay1_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.digital_pfb_clock_sync_xxx_0_0_0, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.qtgui_time_sink_x_3, 0))
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_char_to_float_2, 0))
        self.connect((self.blocks_repack_bits_bb_0_0, 0), (self.blocks_char_to_float_3, 0))
        ...
        self.connect((self.delay1_0, 0), (self.qtgui_time_sink_x_2, 0))
        ...
        self.connect((self.digital_constellation_modulator_0, 0), (self.qtgui_freq_sink_x_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_2.set_samp_rate(self.samp_rate*2)
